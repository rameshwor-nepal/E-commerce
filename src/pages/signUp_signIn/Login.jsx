        ...
        <section>
            <div className='flex ml-[23rem] my-20'>
                    ...
                    <div className='bg-cover bg-center' style={{ backgroundImage: `url(${laptop_bg})` }}>
                        <div className='bg-[#0f0a2b] bg-opacity-[0.50] h-[37rem] w-[30rem] pl-14'>
                            ...
                            <p className='w-[22rem] pl-7 pt-4 text-[16px] text-white'>
                                <span className='text-yellow-400 text-[32px] font-bold'>Get 20% Discount</span>
                ...
                <div className='bg-gray-50 h-[37rem] w-[30rem] drop-shadow-xl'>
                    ...
                    <p className='text-[14px] font-medium px-20 mt-6 '>
                        Password <span className='text-blue-400 font-normal text-[12px] float-right'>Forget Password?</span>
                    </p>
                    <div className=' ml-20 mt-2'>
