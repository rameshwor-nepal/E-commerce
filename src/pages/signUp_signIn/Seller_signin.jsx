    ...
    <div className='flex ml-[23rem] my-20'>
            ...
            <div className='bg-cover bg-center' style={{ backgroundImage:`url(${laptop_bg})` }}>
                  <div className='bg-[#0f0a2b] bg-opacity-[0.50] h-[45rem] w-[30rem] pl-14'>
                    ...
                    <p className='w-[17.5rem] pl-7 pt-4 text-[12px] text-white'>
                      <span className='text-yellow-500 text-[24px] font-medium'>Sign Up</span>  with your mobile number and PAN number and get started..
                    </p>
                  </div>
            </div>
        </div>
        ...
        <div className='bg-gray-50 h-[45rem] w-[30rem] drop-shadow-xl'>
          ...
          <div className=' ml-20 mt-2'>
            <input type="text" className='h-10 w-[20rem] pl-3 border-2 border-purple-300 rounded-md placeholder:text-[12px]' placeholder='Enter your shop name' />
          </div>
          ...
          <div className=' ml-20 mt-2'>
            <input type="text" className='h-10 w-[20rem] pl-3 border-2 border-purple-300 rounded-md placeholder:text-[12px]' placeholder='Enter address' />
          </div>
          ...
          <div className=' ml-20 mt-2'>
            <input type="text" className='h-10 w-[20rem] pl-3 border-2 border-purple-300 rounded-md placeholder:text-[12px]' placeholder='Enter PAN number' />
          </div>
          ...
          <div className=' ml-20 mt-2'>
            <input type="password" className='h-10 w-[20rem] pl-3 border-2 border-purple-300 rounded-md placeholder:text-[12px]' placeholder='Re enter your password' />
          </div>
